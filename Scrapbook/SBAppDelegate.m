...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //create the scrapbook items table view, set its nav bar title, and nav bar add button
    SBItemsViewController *mainView = [[SBItemsViewController alloc] initWithStyle:UITableViewStylePlain];
